...
3.Discover root causes behind high shipping delays.
...
**Key KPIs**
1.On-Time Delivery %: ~42.7%
2.Total Orders: 181K
3.Average Lead Time: 4 days
4.Average Shipping Delay: 0.6 days

**Visuals**
1.Shipping Delay by Region
2.Shipping Delay by Shipping Mode
3.Delivery Status Distribution
4.On-Time Delivery % by Category

**Insights**
1.Less than half of all orders are delivered on time → major efficiency gap.
2.Second Class shipping mode has the highest delay risk.
...
**Visuals**
1.Map of Shipping Delay by Region
2.Delay Risk by Shipping Mode
3.Delay by Product Category
4.Category Table with Lead Time, Delay & On-Time %

**Insights**
1.Delay patterns are global, not region-specific.
2.First & Second Class shipping modes cause most delays.
3.Outdoor & Sporting categories show the highest processing delays.
...
**Visuals**
1.Treemap: Sales by Product Category
2.Scatter Plot: Shipping Delay vs Customer Sales
3.Sales per Customer by Region
4.KPI Cards for Sales, Avg Sales/Customer & Late-Delivery Risk

**Insights**
1.High-revenue categories include Fishing, Cleats, Cardio Equipment, Water Sports.
2.Western Europe, Central America & South America have strongest customer value.
...
3.Global logistics bottlenecks
4.Revenue impact due to delays
